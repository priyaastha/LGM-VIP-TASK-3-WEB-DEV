    ...
    <div class="main">
        <form action="" method="post">
            ...
            <legend><b>ENTER MARKS</b></legend>
                ...
                <input type="text" name="rno" placeholder="STUDENT'S ROLL NO" style="background-color: #aecf18d0;color: black;border: none;transition-duration: 0.4s;cursor: pointer;font-size: 16px;">
                ...
                <input type="submit" value="GENERATE" style="background-color: #aecf18d0;color: black;border: none;transition-duration: 0.4s;cursor: pointer;font-size: 16px;">
            </fieldset>
        </form>
    </div>
